...
@register.simple_tag
def profile_image(user, size=settings.USERS_IMAGE_DEFAULT_SIZE, border_radius=0, **kwargs):
    alt = user.username
    ...
    return render_to_string("users/profile_image/profile_image_tag.html", context)
