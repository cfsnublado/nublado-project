    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lexical_category', models.IntegerField(choices=[(1, 'label_noun'), (2, 'label_adjective'), (3, 'label_verb'), (4, 'label_adverb'), (5, 'label_expression'), (6, 'label_other')], default=1, verbose_name='label_vocab_lexical_category')),
            ],
            options={
